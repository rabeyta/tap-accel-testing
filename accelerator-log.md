...
```json
{
  "projectName" : "tap-accel-testing",
  "repositoryPrefix" : "index.docker.io/arobert505/tap-accel-testing"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->tap-accel-testing]
...
┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->index.docker.io/arob...(truncated)]
